...
public class Grasp_handler {
	//predefined command property
	private String cmd_str = "grasp";
	private int cmd_type = 1; //0 status ; 1 action
	//1 is for action
	//0 is for continously output robot status, e.g., end effector pose.
    ...
    public Grasp_handler(IApplicationData _iapp, UDP_Server_Thread _server, LBR _lbr,FlexFellowIOGroup _IOGroupFellow, ZimmerR840 _gripper, FlexFellow _flexFELLOW_1, MediaFlangeIOGroup _flangeIOGroup) throws IOException{
